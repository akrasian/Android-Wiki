...
javac -d bin\classes -cp %classpath% src\comp3350\wiki\objects\*.java src\comp3350\tests\persistence\*.java src\comp3350\wiki\persistence\*.java src\comp3350\wiki\application\*.java src\comp3350\wiki\business\*.java
javac -d bin\classes -cp %classpath% src\comp3350\tests\objects\*.java src\comp3350\tests\business\*.java src\comp3350\tests\integration\*.java src\comp3350\tests\*.java
